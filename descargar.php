...
<div id="fondo4"><img src="images/fondo4.png"/></div>
...
require_once(TOTALPATH . "libraries/password_compatibility_library.php");

// include the configs / constants for the database connection
require_once(TOTALPATH . "config/db.php");
...
require_once(TOTALPATH . "config/hashing.php");

// load the login class
require_once(TOTALPATH . "classes/Login.php");
...
if ($login->isUserLoggedIn() == true)
{
    ...
    include(TOTALPATH . "jupload/index.html");
...
else
{
    ...
    include(TOTALPATH . "views/not_logged_in.php");
}
